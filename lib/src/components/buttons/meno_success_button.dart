...
/// {@template meno_success_button}
/// A custom primary text button widget that adapts to the platform.
/// {@endtemplate}
class MenoSuccessButton extends FilledButton {
  /// {@macro meno_success_button}
  MenoSuccessButton({
  ...
  ButtonStyle defaultStyleOf(BuildContext context) {
    return _MenoSuccessButtonDefaultStyle(context, size);
  }

  @override
  ButtonStyle? themeStyleOf(BuildContext context) {
    return MenoButtonTheme.of(context).success;
  }
}

class _MenoSuccessButtonDefaultStyle extends ButtonStyle {
  const _MenoSuccessButtonDefaultStyle(this.context, this.size)
    : super(
