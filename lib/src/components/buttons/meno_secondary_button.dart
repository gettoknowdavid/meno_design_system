...
/// {@template meno_secondary_button}
/// A custom secondary text button widget that adapts to the platform.
/// {@endtemplate}
class MenoSecondaryButton extends OutlinedButton {
  /// {@macro meno_secondary_button}
  MenoSecondaryButton({
  ...
  ///
  /// If [icon] is null, will create a [MenoSecondaryButton] instead.
  ///
  factory MenoSecondaryButton.icon({
    ...
    return _MenoSecondaryButtonWithIcon(
      key: key,
      onPressed: onPressed,
      label: label,
      size: size,
  ...
  ButtonStyle defaultStyleOf(BuildContext context) {
    return _MenoSecondaryButtonDefaultStyle(context, size);
  }

  @override
  ButtonStyle? themeStyleOf(BuildContext context) {
    return MenoButtonTheme.of(context).secondary;
  }
}

class _MenoSecondaryButtonWithIcon extends MenoSecondaryButton {
  _MenoSecondaryButtonWithIcon({
    required VoidCallback? onPressed,
...
class _MenoSecondaryButtonDefaultStyle extends ButtonStyle {
  const _MenoSecondaryButtonDefaultStyle(this.context, this.size)
    : super(
